...
COUNT_MODEL = "03" # This will be appended to the saved model's name. To make sure to not overwrite models, increase this.
MAX_QUEUE_SIZE = 5000
WORKERS = 6
...
try:
    def fully_connected_model():
        ...
        layer_1 = keras.layers.Dense(1000, activation='relu')(layer_1)
...
try:
    def timecnn_model():
        ...
        conv1 = keras.layers.Conv1D(filters=6,kernel_size=14,padding=padding,activation='sigmoid')(input_layer)
        conv1 = keras.layers.AveragePooling1D(pool_size=3)(conv1)

        conv2 = keras.layers.Conv1D(filters=12,kernel_size=14,padding=padding,activation='sigmoid')(conv1)
