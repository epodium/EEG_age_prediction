...
COUNT_MODEL = "05" # This will be appended to the saved model's name. To make sure to not overwrite models, increase this.
MAX_QUEUE_SIZE = 5000
WORKERS = 6
...
try:
    def fully_connected_model():
        ...
        layer_1 = keras.layers.Dense(1000, activation='relu')(input_layer_flattened)
...
#         conv1 = keras.layers.Conv1D(filters=128, kernel_size=16, padding='same')(input_layer)
...
#         conv1 = keras.layers.Conv1D(filters=30,kernel_size=7,padding=padding,activation='sigmoid')(input_layer)
#         conv1 = keras.layers.AveragePooling1D(pool_size=3)(conv1)

#         conv2 = keras.layers.Conv1D(filters=60,kernel_size=7,padding=padding,activation='sigmoid')(conv1)
